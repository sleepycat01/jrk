...
@section('title', 'จัดการเครื่องจักร - เพิ่มเครื่องจักร')

@section('content_header')
    <div class="row">
        <div class="col-sm-6">
            <h1 class="m-0 text-dark">
                จัดการเครื่องจักร - เพิ่มเครื่องจักร
            </h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">เพิ่มเครื่องจักร</li>
            </ol>
        </div>
    </div>
@stop
...
@section('content')
    <form action="{{route('machines.store')}}" method="post" id="formStore">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card ">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label>
                                <input type="radio" name="status" checked value="{{\App\Models\Machine::MACHINE_ACTIVE}}">
                                Active
                            </label>
                            &emsp;
                            <label>
                                <input type="radio" name="status" value="{{\App\Models\Machine::MACHINE_INACTIVE}}"> Inactive
                            </label>
                        </div>
                    </div>
